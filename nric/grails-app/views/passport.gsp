            ...
            <div class="row">
                <div class="col-sm-3"><!--left col-->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Passport Number <i class="fa fa-link fa-1x"></i></div>

                        <div class="panel-body"><a href="#">${flash.num}</a></div>
                    </div>
                            ...
                            <form class="form" action="##" method="post" id="registrationForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="first_name"
                                               placeholder="first name" value="${flash.data.fname} ${flash.data.sname}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" id="pob" value="${flash.data.pob}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        <label for="gender"><h4>Nationality</h4></label>
                                        <input type="text" class="form-control" name="nationality" id=""
                                               value="${flash.data.nationality}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        <label for="gender"><h4>Previous Passport</h4></label>
                                        <input type="text" class="form-control" name="prev"
                                               value="${flash.data.prev}">
                                    </div>
                                </div>
